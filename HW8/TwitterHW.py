...
def get_tweets():
	if 'umsi' in CACHE_DICTION:
		...
		results = CACHE_DICTION['umsi']
	else:
		print ('getting data from internet')
		results = api.user_timeline('umsi')
		CACHE_DICTION['umsi'] = results
...
# Include the blank line between each tweets
